...
.. note::
   **THIS DOCUMENTATION CREATION WAS AUTOMATICALLY TRIGGERED BY:** TML Solution Container (RUNNING IN KUBERNETES)
...
.. code-block::
   ...
   docker run -d -p 40133:40133 -p 46513:46513 -p 57373:57373 -p 9002:9002 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=40133 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=46513  \
          --env SOLUTIONVIPERVIZPORT=57373 \
...
It can be accessed by entering: http://localhost:46513
...
.. important::
   http://localhost:57373/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:57373/<html file>
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=40133, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35049, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41721, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38921, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37969, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34303, HPDEHOST=127.0.1.1, HPDEPORT=38601, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37471
