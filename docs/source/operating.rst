...
Generated On: 2024-12-24 22:26:01 UTC
...
.. code-block::
   ...
   docker run -d -p 50895:50895 -p 50491:50491 -p 37977:37977 -p 9002:9002 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=50895 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=50491  \
          --env SOLUTIONVIPERVIZPORT=37977 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=50895, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39391, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39279, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46659, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38083, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35395, HPDEHOST=127.0.1.1, HPDEPORT=36877, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44913

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8292-iotsolution-grpc-3f10,solution_preprocessing_dag_grpc-iotsolution-grpc-3f10, python-preprocess-1888-iotsolution-grpc-3f10,solution_preprocessing_dag_grpc-iotsolution-grpc-3f10, python-preprocess2-2700-iotsolution-grpc-3f10,solution_preprocessing_dag_grpc-iotsolution-grpc-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
