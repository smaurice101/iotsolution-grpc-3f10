[iotsolution-grpc-3f10] Operating Details
====================================

Generated On: 2024-12-21 03:21:45 UTC
...
.. important::
   ...
   **not be valid if your [iotsolution-grpc-3f10] container is NOT running**.

.. tip::
   You must have your [iotsolution-grpc-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   maadsdocker/iotsolution-grpc-3f10-amd64 (https://hub.docker.com/r/maadsdocker/iotsolution-grpc-3f10-amd64)
...
.. code-block::
   ...
   docker run -d -p 52753:52753 -p 53515:53515 -p 34335:34335 -p 9002:9002 \
          --env TSS=0 \
          --env SOLUTIONNAME=iotsolution-grpc-3f10 \
          --env SOLUTIONDAG=solution_preprocessing_dag_grpc-iotsolution-grpc-3f10 \
          --env GITUSERNAME=smaurice101 \
          --env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \
          --env SOLUTIONEXTERNALPORT=52753 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=53515  \
          --env SOLUTIONVIPERVIZPORT=34335 \
          ...
          maadsdocker/iotsolution-grpc-3f10-amd64
...
[iotsolution-grpc-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/iotsolution-grpc-3f10
...
.. important::
   https://iotsolution-grpc-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag_grpc-iotsolution-grpc-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=52753, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45549, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=40615, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40077, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36833, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42525, HPDEHOST=127.0.1.1, HPDEPORT=33389, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43329

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-929-iotsolution-grpc-3f10,solution_preprocessing_dag_grpc-iotsolution-grpc-3f10, python-preprocess-1026-iotsolution-grpc-3f10,solution_preprocessing_dag_grpc-iotsolution-grpc-3f10, python-preprocess2-4471-iotsolution-grpc-3f10,solution_preprocessing_dag_grpc-iotsolution-grpc-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
