...
.. code-block::
   ...
   kubectl port-forward deployment/iotsolution-grpc-3f10 37977:37977

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:37977/iot-failure-seneca.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
-------------
   ...
   .. code-block::
    ...
    ############# nginx-ingress-iotsolution-grpc-3f10-grpc.yml
